...
public class Product {
    ...
    public Product(final String productID, final String sku) {
        this.productID = Objects.requireNonNull(productID);
        setSku(sku);
    }

    public Product(final String productID, final String sku, final String designation, final String description) {
        this(productID, sku);
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(sku, product.sku) && Objects.equals(designation, product.designation) && Objects.equals(description, product.description);
    }
}
