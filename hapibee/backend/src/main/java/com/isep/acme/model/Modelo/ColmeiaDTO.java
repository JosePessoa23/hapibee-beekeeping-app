...
public class ColmeiaDTO {
    ...
    public ColmeiaDTO(Long colmeiaId,Long numeroColmeia, int alças, String tipo, String dataRainha) {
        this.id = colmeiaId;
    ...
    public ColmeiaDTO(Long numeroColmeia, int alças, String tipo, String dataRainha, Long colmeia_mae) {
        this.numeroColmeia = numeroColmeia;
        this.alças = alças;
        this.tipo = tipo;
        this.dataRainha = dataRainha;
    ...
    public ColmeiaDTO(Long id, Long numeroColmeia, int alças, String tipo, String dataRainha, Long colmeia_mae) {
        this.numeroColmeia = numeroColmeia;
        this.alças = alças;
        this.tipo = tipo;
        this.dataRainha = dataRainha;
