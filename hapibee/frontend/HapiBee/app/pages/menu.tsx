...
export default function Menu() {
  ...
  function buttonHandler2(): void {
    navigation.navigate("pages/infoApicultorDA");
  }
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          <Image
            source={require("../../assets/images/apiarioIcon.png")}
            style={styles.image}
          ></Image>
          <Image
            source={require("../../assets/images/apiarioIcon.png")}
        ...
        <Text style={styles.text}>Gestão de apiários</Text>
      </Pressable>
      <Pressable
        style={[
          styles.button,
      ...
      >
        <Image
          source={require("../../assets/images/declaracaoIcon.png")}
          style={styles.image}
        ></Image>
        <Text style={styles.text}>Declaração anual de existências</Text>
      </Pressable>
    </View>
  );
}
