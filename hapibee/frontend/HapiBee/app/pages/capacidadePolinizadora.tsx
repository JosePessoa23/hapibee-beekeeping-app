...
export default function CapacidadePolinizadora() {
  ...
  async function buttonHandler() {
    navigation.navigate("pages/observacoes", {
      apiarioID: apiarioID,
      ...
      inspecao: {
        ...
        capacidade_polinizadora: selected,
  ...
  async function buttonHandlera() {
    navigation.navigate("pages/produtividade", {
      apiarioID: apiarioID,
  ...
  return (
    <View style={styles.topContainer}>
      ...
      <View style={styles.container}>
        <Text style={styles.optionTitle}>Capacidade Polinizadora</Text>
